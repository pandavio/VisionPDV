...
public static com.pdv.vision.b4xpagesdelegator _delegate = null;
...
public static com.pdv.vision.b4xpagesmanager._b4amenuitem  _addmenuitem(anywheresoftware.b4a.BA _ba,Object _b4xpage,Object _title) throws Exception{
...
if (true) return _getmanager(_ba)._addmenuitem /*com.pdv.vision.b4xpagesmanager._b4amenuitem*/ (_b4xpage,_title);
...
public static com.pdv.vision.b4xpagesmanager  _getmanager(anywheresoftware.b4a.BA _ba) throws Exception{
 //BA.debugLineNum = 14;BA.debugLine="Public Sub GetManager As B4XPagesManager";
 //BA.debugLineNum = 15;BA.debugLine="Return mPM";
if (true) return (com.pdv.vision.b4xpagesmanager)(_mpm);
...
if (true) return _getmanager(_ba)._findpifromb4xpage /*com.pdv.vision.b4xpagesmanager._b4xpageinfo*/ (_b4xpage).Parent /*com.pdv.vision.b4xpagesmanager._b4xpageparent*/ .NativeType /*anywheresoftware.b4a.objects.ActivityWrapper*/ ;
...
if (true) return _getmanager(_ba)._findpifromb4xpage /*com.pdv.vision.b4xpagesmanager._b4xpageinfo*/ (_b4xpage).Id /*String*/ ;
...
if (true) return _mpm instanceof com.pdv.vision.b4xpagesmanager;
 //BA.debugLineNum = 11;BA.debugLine="End Sub";
return false;
}
public static com.pdv.vision.b4xmainpage  _mainpage(anywheresoftware.b4a.BA _ba) throws Exception{
...
if (true) return _getmanager(_ba)._mainpage /*com.pdv.vision.b4xmainpage*/ ;
...
_delegate = new com.pdv.vision.b4xpagesdelegator();
