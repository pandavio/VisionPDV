...
public class httpjob extends B4AClass.ImplB4AClass implements BA.SubDelegator{
    ...
    private void innerInitialize(BA _ba) throws Exception {
        if (ba == null) {
            ba = new BA(_ba, this, htSubs, "com.pdv.vision.httpjob");
            if (htSubs == null) {
        ...
        if (BA.isShellModeRuntimeCheck(ba)) 
			   this.getClass().getMethod("_class_globals", com.pdv.vision.httpjob.class).invoke(this, new Object[] {null});
        else
...
__c.LogImpl("917956869",("Invalid link: "+__c.SmartStringFormatter("",(Object)(_link))+""),0);
...
__c.LogImpl("917563660",("Invalid link: "+__c.SmartStringFormatter("",(Object)(_link))+""),0);
...
__c.LogImpl("917301509",("Invalid link: "+__c.SmartStringFormatter("",(Object)(_link))+""),0);
...
__c.LogImpl("917825800","Cannot send files from the assets folder.",0);
...
String _value = "";
String _s = "";
com.pdv.vision.httpjob._multipartfiledata _fd = null;
anywheresoftware.b4a.objects.streams.File.InputStreamWrapper _in = null;
...
_fd = (com.pdv.vision.httpjob._multipartfiledata)(group17.Get(index17));
