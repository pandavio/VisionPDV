...
public class camex2 extends B4AClass.ImplB4AClass implements BA.SubDelegator{
    ...
    private void innerInitialize(BA _ba) throws Exception {
        if (ba == null) {
            ba = new BA(_ba, this, htSubs, "com.pdv.vision.camex2");
            if (htSubs == null) {
        ...
        if (BA.isShellModeRuntimeCheck(ba)) 
			   this.getClass().getMethod("_class_globals", com.pdv.vision.camex2.class).invoke(this, new Object[] {null});
        else
...
boolean[] _i = null;
boolean _ii = false;
 //BA.debugLineNum = 481;BA.debugLine="Private Sub BoolsToList (Obj As Object) As List";
 //BA.debugLineNum = 482;BA.debugLine="Dim res As List";
_res = new anywheresoftware.b4a.objects.collections.List();
 //BA.debugLineNum = 483;BA.debugLine="res.Initialize";
_res.Initialize();
 //BA.debugLineNum = 484;BA.debugLine="If Obj = Null Then Return res";
if (_obj== null) { 
if (true) return _res;};
 //BA.debugLineNum = 485;BA.debugLine="Dim i() As Boolean = Obj";
_i = (boolean[])(_obj);
 //BA.debugLineNum = 486;BA.debugLine="For Each ii As Boolean In i";
{
...
_ii = group5[index5];
 //BA.debugLineNum = 487;BA.debugLine="res.Add(ii)";
_res.Add((Object)(_ii));
 }
};
 //BA.debugLineNum = 489;BA.debugLine="Return res";
if (true) return _res;
...
byte[] _i = null;
byte _ii = (byte)0;
 //BA.debugLineNum = 492;BA.debugLine="Private Sub BytesToList (Obj As Object) As List";
 //BA.debugLineNum = 493;BA.debugLine="Dim res As List";
_res = new anywheresoftware.b4a.objects.collections.List();
 //BA.debugLineNum = 494;BA.debugLine="res.Initialize";
_res.Initialize();
 //BA.debugLineNum = 495;BA.debugLine="If Obj = Null Then Return res";
if (_obj== null) { 
if (true) return _res;};
 //BA.debugLineNum = 496;BA.debugLine="Dim i() As Byte = Obj";
_i = (byte[])(_obj);
 //BA.debugLineNum = 497;BA.debugLine="For Each ii As Byte In i";
{
...
for (; index5 < groupLen5;index5++){
_ii = group5[index5];
 //BA.debugLineNum = 498;BA.debugLine="res.Add(ii)";
_res.Add((Object)(_ii));
 }
};
...
public ResumableSub_CreateSurface(com.pdv.vision.camex2 parent) {
this.parent = parent;
}
com.pdv.vision.camex2 parent;
...
anywheresoftware.b4a.objects.drawable.CanvasWrapper.BitmapWrapper _bmp = null;
 //BA.debugLineNum = 368;BA.debugLine="Public Sub DataToBitmap(Data() As Byte) As Bitmap";
 //BA.debugLineNum = 369;BA.debugLine="Dim in As InputStream";
_in = new anywheresoftware.b4a.objects.streams.File.InputStreamWrapper();
 //BA.debugLineNum = 370;BA.debugLine="in.InitializeFromBytesArray(Data, 0, Data.Length)";
_in.InitializeFromBytesArray(_data,(int) (0),_data.length);
 //BA.debugLineNum = 371;BA.debugLine="Dim bmp As Bitmap";
_bmp = new anywheresoftware.b4a.objects.drawable.CanvasWrapper.BitmapWrapper();
 //BA.debugLineNum = 372;BA.debugLine="bmp.Initialize2(in)";
_bmp.Initialize2((java.io.InputStream)(_in.getObject()));
 //BA.debugLineNum = 373;BA.debugLine="in.Close";
_in.Close();
 //BA.debugLineNum = 374;BA.debugLine="Return bmp";
if (true) return _bmp;
...
anywheresoftware.b4a.objects.streams.File.OutputStreamWrapper _out = null;
 //BA.debugLineNum = 378;BA.debugLine="Public Sub DataToFile(Data() As Byte, Dir As Strin";
 //BA.debugLineNum = 379;BA.debugLine="Dim out As OutputStream = File.OpenOutput(Dir, Fi";
_out = new anywheresoftware.b4a.objects.streams.File.OutputStreamWrapper();
_out = __c.File.OpenOutput(_dir,_filename,__c.False);
 //BA.debugLineNum = 380;BA.debugLine="out.WriteBytes(Data, 0, Data.Length)";
_out.WriteBytes(_data,(int) (0),_data.length);
 //BA.debugLineNum = 381;BA.debugLine="out.Close";
_out.Close();
...
float[] _f = null;
float _ff = 0f;
 //BA.debugLineNum = 515;BA.debugLine="Private Sub FloatsToList (Obj As Object) As List";
 //BA.debugLineNum = 516;BA.debugLine="Dim res As List";
_res = new anywheresoftware.b4a.objects.collections.List();
 //BA.debugLineNum = 517;BA.debugLine="res.Initialize";
_res.Initialize();
 //BA.debugLineNum = 518;BA.debugLine="If Obj = Null Then Return res";
if (_obj== null) { 
if (true) return _res;};
 //BA.debugLineNum = 519;BA.debugLine="Dim f() As Float = Obj";
_f = (float[])(_obj);
 //BA.debugLineNum = 520;BA.debugLine="For Each ff As Float In f";
{
...
for (; index5 < groupLen5;index5++){
_ff = group5[index5];
 //BA.debugLineNum = 521;BA.debugLine="res.Add(ff)";
_res.Add((Object)(_ff));
 }
};
...
public ResumableSub_FocusAndTakePicture(com.pdv.vision.camex2 parent,int _mytaskindex) {
this.parent = parent;
...
parent.__c.LogImpl("74653060","Focus not supported",0);
 if (true) break;
...
parent.__c.LogImpl("74653068","Focus failed",0);
 if (true) break;
...
parent.__c.LogImpl("74653070","Focused!",0);
 if (true) break;
...
anywheresoftware.b4j.object.JavaObject _jo = null;
 //BA.debugLineNum = 389;BA.debugLine="Private Sub GetFromCameraCharacteristic (Field As";
 //BA.debugLineNum = 390;BA.debugLine="Dim jo As JavaObject = Camera.GetCameraCharacteri";
...
_jo = (anywheresoftware.b4j.object.JavaObject) anywheresoftware.b4a.AbsObjectWrapper.ConvertToWrapper(new anywheresoftware.b4j.object.JavaObject(), (java.lang.Object)(_camera.GetCameraCharacteristics(_id)));
 //BA.debugLineNum = 391;BA.debugLine="Return jo.RunMethod(\"get\", Array(StaticCameraChar";
...
anywheresoftware.b4j.object.JavaObject _jo = null;
 //BA.debugLineNum = 399;BA.debugLine="Private Sub GetFromCaptureRequest(CaptureRequest A";
 //BA.debugLineNum = 400;BA.debugLine="Dim jo As JavaObject = CaptureRequest";
_jo = new anywheresoftware.b4j.object.JavaObject();
_jo = (anywheresoftware.b4j.object.JavaObject) anywheresoftware.b4a.AbsObjectWrapper.ConvertToWrapper(new anywheresoftware.b4j.object.JavaObject(), (java.lang.Object)(_capturerequest));
 //BA.debugLineNum = 401;BA.debugLine="Return jo.RunMethod(\"get\", Array(StaticCaptureReq";
...
anywheresoftware.b4j.object.JavaObject _jresult = null;
 //BA.debugLineNum = 394;BA.debugLine="Private Sub GetFromCaptureResult(CaptureResult As";
 //BA.debugLineNum = 395;BA.debugLine="Dim jresult As JavaObject = CaptureResult";
...
_jresult = (anywheresoftware.b4j.object.JavaObject) anywheresoftware.b4a.AbsObjectWrapper.ConvertToWrapper(new anywheresoftware.b4j.object.JavaObject(), (java.lang.Object)(_captureresult));
 //BA.debugLineNum = 396;BA.debugLine="Return jresult.RunMethod(\"get\", Array(StaticCaptu";
...
public boolean  _getisfrontfacingcamera() throws Exception{
 //BA.debugLineNum = 385;BA.debugLine="Public Sub getIsFrontFacingCamera As Boolean";
 //BA.debugLineNum = 386;BA.debugLine="Return 0 = GetFromCameraCharacteristic(\"LENS_FACI";
...
anywheresoftware.b4j.object.JavaObject _jo = null;
 //BA.debugLineNum = 360;BA.debugLine="Public Sub GetPreviewBitmap(Width As Int, Height A";
 //BA.debugLineNum = 361;BA.debugLine="Dim mbmp As Bitmap";
_mbmp = new anywheresoftware.b4a.objects.drawable.CanvasWrapper.BitmapWrapper();
 //BA.debugLineNum = 362;BA.debugLine="mbmp.InitializeMutable(Width, Height)";
_mbmp.InitializeMutable(_width,_height);
 //BA.debugLineNum = 363;BA.debugLine="Dim jo As JavaObject = tv";
_jo = new anywheresoftware.b4j.object.JavaObject();
_jo = (anywheresoftware.b4j.object.JavaObject) anywheresoftware.b4a.AbsObjectWrapper.ConvertToWrapper(new anywheresoftware.b4j.object.JavaObject(), (java.lang.Object)(_tv.getObject()));
 //BA.debugLineNum = 364;BA.debugLine="Return jo.RunMethod(\"getBitmap\", Array(mbmp))";
...
int[] _f = null;
int _mode = 0;
 //BA.debugLineNum = 417;BA.debugLine="Private Sub IntsToConstsList (Ints As Object, Cons";
 //BA.debugLineNum = 418;BA.debugLine="Dim res As List";
_res = new anywheresoftware.b4a.objects.collections.List();
 //BA.debugLineNum = 419;BA.debugLine="res.Initialize";
_res.Initialize();
 //BA.debugLineNum = 420;BA.debugLine="If Ints = Null Then Return res";
if (_ints== null) { 
if (true) return _res;};
 //BA.debugLineNum = 421;BA.debugLine="Dim f() As Int = Ints";
_f = (int[])(_ints);
 //BA.debugLineNum = 422;BA.debugLine="For Each mode As Int In f";
{
final int[] group5 = _f;
final int groupLen5 = group5.length
;int index5 = 0;
...
for (; index5 < groupLen5;index5++){
_mode = group5[index5];
 //BA.debugLineNum = 423;BA.debugLine="If mode >=0 And mode < Consts.Size Then";
if (_mode>=0 && _mode<_consts.getSize()) { 
 //BA.debugLineNum = 424;BA.debugLine="res.Add(Consts.Get(mode))";
_res.Add(_consts.Get(_mode));
 }else {
 //BA.debugLineNum = 426;BA.debugLine="Log(Consts) 'ignore";
__c.LogImpl("75505033",BA.ObjectToString(_consts),0);
 //BA.debugLineNum = 427;BA.debugLine="Log(\"Unknown consts: \" & mode)";
__c.LogImpl("75505034","Unknown consts: "+BA.NumberToString(_mode),0);
 };
 }
};
 //BA.debugLineNum = 430;BA.debugLine="Return res";
if (true) return _res;
...
int[] _i = null;
int _ii = 0;
 //BA.debugLineNum = 504;BA.debugLine="Private Sub IntsToList (Obj As Object) As List";
 //BA.debugLineNum = 505;BA.debugLine="Dim res As List";
_res = new anywheresoftware.b4a.objects.collections.List();
 //BA.debugLineNum = 506;BA.debugLine="res.Initialize";
_res.Initialize();
 //BA.debugLineNum = 507;BA.debugLine="If Obj = Null Then Return res";
if (_obj== null) { 
if (true) return _res;};
 //BA.debugLineNum = 508;BA.debugLine="Dim i() As Int = Obj";
_i = (int[])(_obj);
 //BA.debugLineNum = 509;BA.debugLine="For Each ii As Int In i";
{
final int[] group5 = _i;
final int groupLen5 = group5.length
;int index5 = 0;
...
for (; index5 < groupLen5;index5++){
_ii = group5[index5];
 //BA.debugLineNum = 510;BA.debugLine="res.Add(ii)";
_res.Add((Object)(_ii));
 }
};
...
int _i = 0;
 //BA.debugLineNum = 405;BA.debugLine="Private Sub IntToConst (Int1 As Object, Consts As";
 //BA.debugLineNum = 406;BA.debugLine="If Int1 = Null Then Return \"\"";
if (_int1== null) { 
if (true) return "";};
 //BA.debugLineNum = 407;BA.debugLine="Dim i As Int = Int1";
_i = (int)(BA.ObjectToNumber(_int1));
 //BA.debugLineNum = 408;BA.debugLine="If i >= 0 And i < Consts.Size Then";
if (_i>=0 && _i<_consts.getSize()) { 
 //BA.debugLineNum = 409;BA.debugLine="Return Consts.Get(i)";
if (true) return BA.ObjectToString(_consts.Get(_i));
 }else {
 //BA.debugLineNum = 411;BA.debugLine="Log(Consts)'ignore";
__c.LogImpl("75439494",BA.ObjectToString(_consts),0);
 //BA.debugLineNum = 412;BA.debugLine="Log(\"Unknown const: \" & i)";
__c.LogImpl("75439495","Unknown const: "+BA.NumberToString(_i),0);
...
Object[] _o = null;
Object _oo = null;
 //BA.debugLineNum = 470;BA.debugLine="Private Sub ObjectsToList(Obj As Object) As List";
 //BA.debugLineNum = 471;BA.debugLine="Dim res As List";
_res = new anywheresoftware.b4a.objects.collections.List();
 //BA.debugLineNum = 472;BA.debugLine="res.Initialize";
_res.Initialize();
 //BA.debugLineNum = 473;BA.debugLine="If Obj = Null Then Return res";
if (_obj== null) { 
if (true) return _res;};
 //BA.debugLineNum = 474;BA.debugLine="Dim o() As Object = Obj";
_o = (Object[])(_obj);
 //BA.debugLineNum = 475;BA.debugLine="For Each oo As Object In o";
{
...
for (; index5 < groupLen5;index5++){
_oo = group5[index5];
 //BA.debugLineNum = 476;BA.debugLine="res.Add(oo)";
_res.Add(_oo);
 }
};
 //BA.debugLineNum = 478;BA.debugLine="Return res";
if (true) return _res;
...
public ResumableSub_OpenCamera(com.pdv.vision.camex2 parent,boolean _front) {
this.parent = parent;
this._front = _front;
}
com.pdv.vision.camex2 parent;
...
parent.__c.LogImpl("72621448","Camera not found.",0);
...
parent.__c.LogImpl("72621454","Failed to open camera",0);
...
public ResumableSub_PrepareSurface(com.pdv.vision.camex2 parent,int _mytaskindex) {
this.parent = parent;
this._mytaskindex = _mytaskindex;
}
com.pdv.vision.camex2 parent;
...
public ResumableSub_PrepareSurfaceForVideo(com.pdv.vision.camex2 parent,int _mytaskindex,String _dir,String _filename) {
this.parent = parent;
this._mytaskindex = _mytaskindex;
this._dir = _dir;
...
Object _value = null;
String _typ = "";
 //BA.debugLineNum = 448;BA.debugLine="Private Sub PrintAllKeys (CameraMap As Object, tit";
 //BA.debugLineNum = 449;BA.debugLine="Log($\"******  ${title} **********\"$)";
__c.LogImpl("75701633",("******  "+__c.SmartStringFormatter("",(Object)(_title))+" **********"),0);
 //BA.debugLineNum = 450;BA.debugLine="Dim jo As JavaObject = CameraMap";
_jo = new anywheresoftware.b4j.object.JavaObject();
_jo = (anywheresoftware.b4j.object.JavaObject) anywheresoftware.b4a.AbsObjectWrapper.ConvertToWrapper(new anywheresoftware.b4j.object.JavaObject(), (java.lang.Object)(_cameramap));
 //BA.debugLineNum = 451;BA.debugLine="Dim keys As List = jo.RunMethod(\"getKeys\", Null)";
...
_keys = (anywheresoftware.b4a.objects.collections.List) anywheresoftware.b4a.AbsObjectWrapper.ConvertToWrapper(new anywheresoftware.b4a.objects.collections.List(), (java.util.List)(_jo.RunMethod("getKeys",(Object[])(__c.Null))));
 //BA.debugLineNum = 452;BA.debugLine="For Each k As JavaObject In keys";
...
_k = (anywheresoftware.b4j.object.JavaObject) anywheresoftware.b4a.AbsObjectWrapper.ConvertToWrapper(new anywheresoftware.b4j.object.JavaObject(), (java.lang.Object)(group4.Get(index4)));
 //BA.debugLineNum = 453;BA.debugLine="Dim value As Object = jo.RunMethod(\"get\", Array(";
_value = _jo.RunMethod("get",new Object[]{(Object)(_k.getObject())});
 //BA.debugLineNum = 454;BA.debugLine="If value = Null Then Continue";
if (_value== null) { 
if (true) continue;};
 //BA.debugLineNum = 455;BA.debugLine="Dim typ As String = GetType(value)";
_typ = __c.GetType(_value);
 //BA.debugLineNum = 456;BA.debugLine="If typ = \"[F\" Then";
if ((_typ).equals("[F")) { 
 //BA.debugLineNum = 457;BA.debugLine="value = FloatsToList(value)";
_value = (Object)(_floatstolist(_value).getObject());
 }else if((_typ).equals("[I")) { 
 //BA.debugLineNum = 459;BA.debugLine="value = IntsToList(value)";
_value = (Object)(_intstolist(_value).getObject());
 }else if((_typ).equals("[Z")) { 
 //BA.debugLineNum = 461;BA.debugLine="value = BoolsToList(value)";
_value = (Object)(_boolstolist(_value).getObject());
 }else if((_typ).equals("[B")) { 
 //BA.debugLineNum = 463;BA.debugLine="value = BytesToList(value)";
_value = (Object)(_bytestolist(_value).getObject());
 }else if(_typ.startsWith("[")) { 
 //BA.debugLineNum = 465;BA.debugLine="value = ObjectsToList(value)";
_value = (Object)(_objectstolist(_value).getObject());
 };
 //BA.debugLineNum = 467;BA.debugLine="Log($\"${k.RunMethod(\"getName\", Null)}: ${value}\"";
__c.LogImpl("75701651",(""+__c.SmartStringFormatter("",_k.RunMethod("getName",(Object[])(__c.Null)))+": "+__c.SmartStringFormatter("",_value)+""),0);
 }
};
...
_previewsettingsmap.Put((Object)("SCALER_CROP_REGION"),(Object)(_r.getObject()));
 //BA.debugLineNum = 256;BA.debugLine="CaptureSettingMap.Put(\"SCALER_CROP_REGION\", r)";
_capturesettingmap.Put((Object)("SCALER_CROP_REGION"),(Object)(_r.getObject()));
...
String _key = "";
 //BA.debugLineNum = 433;BA.debugLine="Private Sub SetSettingsFromMap (Builder As JavaObj";
 //BA.debugLineNum = 434;BA.debugLine="For Each key As String In m.Keys";
{
...
_key = BA.ObjectToString(group1.Get(index1));
 //BA.debugLineNum = 435;BA.debugLine="Builder.RunMethod(\"set\", Array(StaticCaptureRequ";
...
public String  _stop() throws Exception{
 //BA.debugLineNum = 439;BA.debugLine="Public Sub Stop";
 //BA.debugLineNum = 440;BA.debugLine="RecordingVideo = False";
_recordingvideo = __c.False;
 //BA.debugLineNum = 441;BA.debugLine="Camera.Stop";
_camera.Stop();
 //BA.debugLineNum = 442;BA.debugLine="TaskIndex = TaskIndex + 1";
...
__c.LogImpl("73080197",BA.ObjectToString(__c.LastException(ba)),0);
 };
...
public ResumableSub_TakePictureNow(com.pdv.vision.camex2 parent,int _mytaskindex) {
this.parent = parent;
this._mytaskindex = _mytaskindex;
}
com.pdv.vision.camex2 parent;
...
//C
this.state = 1;
 //BA.debugLineNum = 317;BA.debugLine="If MyTaskIndex <> TaskIndex Then";
if (true) break;
...
//C
this.state = 4;
 //BA.debugLineNum = 318;BA.debugLine="Dim Empty() As Byte";
_empty = new byte[(int) (0)];
;
 //BA.debugLineNum = 319;BA.debugLine="Return Empty";
if (true) {
parent.__c.ReturnFromResumableSub(this,(Object)(_empty));return;};
 if (true) break;
...
this.state = 5;
;
 //BA.debugLineNum = 321;BA.debugLine="Camera.AbortCaptures";
parent._camera.AbortCaptures();
 //BA.debugLineNum = 322;BA.debugLine="Dim builder As JavaObject = Camera.CreateCaptureB";
...
_builder = (anywheresoftware.b4j.object.JavaObject) anywheresoftware.b4a.AbsObjectWrapper.ConvertToWrapper(new anywheresoftware.b4j.object.JavaObject(), (java.lang.Object)(parent._camera.CreateCaptureBuilder()));
 //BA.debugLineNum = 323;BA.debugLine="CaptureSettingMap.Put(\"JPEG_ORIENTATION\", GetHint";
parent._capturesettingmap.Put((Object)("JPEG_ORIENTATION"),(Object)(parent._gethintorientation()));
 //BA.debugLineNum = 324;BA.debugLine="SetSettingsFromMap(builder, CaptureSettingMap)";
parent._setsettingsfrommap(_builder,parent._capturesettingmap);
 //BA.debugLineNum = 325;BA.debugLine="Dim CaptureRequest As Object = Camera.AddCaptureR";
_capturerequest = parent._camera.AddCaptureRequest((Object)(_builder.getObject()));
 //BA.debugLineNum = 326;BA.debugLine="If PrintKeys Then PrintAllKeys(CaptureRequest, \"C";
if (true) break;
...
this.state = -1;
;
 //BA.debugLineNum = 327;BA.debugLine="Wait For Camera_PictureTaken (Data() As Byte)";
...
_data = (byte[]) result[0];
;
 //BA.debugLineNum = 328;BA.debugLine="StartPreview(MyTaskIndex, False)";
...
public ResumableSub_TakePicturesNow(com.pdv.vision.camex2 parent,int _mytaskindex,int _numberofpictures) {
this.parent = parent;
this._mytaskindex = _mytaskindex;
...
//C
this.state = 1;
 //BA.debugLineNum = 339;BA.debugLine="If MyTaskIndex <> TaskIndex Then Return False";
if (true) break;
...
this.state = 7;
;
 //BA.debugLineNum = 340;BA.debugLine="Camera.AbortCaptures";
parent._camera.AbortCaptures();
 //BA.debugLineNum = 341;BA.debugLine="Dim builder As JavaObject = Camera.CreateCaptureB";
_builder = new anywheresoftware.b4j.object.JavaObject();
_builder = (anywheresoftware.b4j.object.JavaObject) anywheresoftware.b4a.AbsObjectWrapper.ConvertToWrapper(new anywheresoftware.b4j.object.JavaObject(), (java.lang.Object)(parent._camera.CreateCaptureBuilder()));
 //BA.debugLineNum = 342;BA.debugLine="CaptureSettingMap.Put(\"JPEG_ORIENTATION\", GetHint";
parent._capturesettingmap.Put((Object)("JPEG_ORIENTATION"),(Object)(parent._gethintorientation()));
 //BA.debugLineNum = 343;BA.debugLine="SetSettingsFromMap(builder, CaptureSettingMap)";
parent._setsettingsfrommap(_builder,parent._capturesettingmap);
 //BA.debugLineNum = 344;BA.debugLine="Dim result As List";
_result = new anywheresoftware.b4a.objects.collections.List();
 //BA.debugLineNum = 345;BA.debugLine="result.Initialize";
_result.Initialize();
 //BA.debugLineNum = 346;BA.debugLine="For i = 1 To NumberOfPictures";
if (true) break;
...
//C
this.state = 15;
 //BA.debugLineNum = 347;BA.debugLine="Camera.AddCaptureRequest(builder)";
parent._camera.AddCaptureRequest((Object)(_builder.getObject()));
 if (true) break;
if (true) break;
;
 //BA.debugLineNum = 349;BA.debugLine="For i = 1 To NumberOfPictures";
...
//C
this.state = 17;
 //BA.debugLineNum = 350;BA.debugLine="Wait For Camera_PictureTaken (Data() As Byte)";
parent.__c.WaitFor("camera_picturetaken", ba, this, null);
this.state = 18;
return;
case 18:
...
_data = (byte[]) result[0];
;
 //BA.debugLineNum = 351;BA.debugLine="result.Add(Data)";
...
this.state = -1;
;
 //BA.debugLineNum = 353;BA.debugLine="StartPreview(MyTaskIndex, False)";
parent._startpreview(_mytaskindex,parent.__c.False);
 //BA.debugLineNum = 354;BA.debugLine="Return result";
if (true) {
...
public ResumableSub_WaitForFocusWithTimeout(com.pdv.vision.camex2 parent,int _timeoutms) {
this.parent = parent;
